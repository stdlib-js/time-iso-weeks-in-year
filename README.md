...
```javascript
isoWeeksInYear = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/time-iso-weeks-in-year@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/time-iso-weeks-in-year@umd/bundle.js"></script>
```
